...
| Версия | Дата | Канал |
| --- | --- | --- |
| v0.8.8 · [в файле](#v-0-8-8) | 2026-09-22 | Ожидает тега |
...
## v0.8.8 — 2026-09-22 · Ожидает тега
...
Страница релиза появится после публикации тега `v0.8.8`; заметки — в [release-notes/v0.8.8.md](https://github.com/Sovero/hf/blob/HEAD/release-notes/v0.8.8.md).
