...
| Версия | Дата | Канал |
| --- | --- | --- |
| v0.8.4 · [в файле](#v-0-8-4) | 2026-09-21 | Ожидает тега |
...
## v0.8.4 — 2026-09-21 · Ожидает тега
...
Страница релиза появится после публикации тега `v0.8.4`; заметки — в [release-notes/v0.8.4.md](https://github.com/Sovero/hf/blob/HEAD/release-notes/v0.8.4.md).
